      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="text-5xl font-bold text-transervica-green mb-2">{years}</div>
          ...
          <div className="text-center">
            <div className="text-5xl font-bold text-transervica-green mb-2">{reliability}%</div>
            <div className="text-xl font-semibold text-gray-700">Confiabilidad</div>
