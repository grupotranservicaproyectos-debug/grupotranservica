        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#servicios" className="hover:text-white transition">Transporte Cargas Excepcionales</a></li>
              <li><a href="#servicios" className="hover:text-white transition">Izamiento con Grúas Alemanas</a></li>
              <li><a href="#servicios" className="hover:text-white transition">Logística de Ingeniería</a></li>
              <li><a href="#equipos" className="hover:text-white transition">Equipos SCHEUERLE</a></li>
              <li><a href="#equipos" className="hover:text-white transition">Grúas Grove y Liebherr</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <div className="flex items-start">
                ...
                <span className="text-sm">Carretera Nacional Maracay Mariara Km 9, Mariara, Edo. Carabobo, Venezuela</span>
              </div>
            </div>
            <div className="mt-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-transervica-green hover:text-transervica-light-green transition text-sm font-semibold"
              >
                VER EN GOOGLE MAPS
              </a>
            </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-300">
            <div className="mb-4 md:mb-0">
              <p>&copy; 2024 TRANSERVICA, C.A. Todos los derechos reservados.</p>
              <p className="text-sm">RIF: J-00207776-0 | 40 años transportando el futuro de Venezuela</p>
            </div>
            <div className="text-center">
              <button 
                onClick={scrollToContact}
                className="bg-transervica-green text-white px-4 py-2 rounded-lg font-semibold hover:bg-transervica-light-green transition text-sm"
              >
                SEGUIR EN REDES
              </button>
            </div>
