  ...
  return (
    <section id="nosotros" className="relative py-20 bg-gradient-to-br from-white via-gray-50 to-gray-100 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-transervica-red/15 to-transparent"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-transervica-red/20 to-transervica-blue-light/10 rounded-full blur-3xl"></div>
        <div className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-transervica-blue-light/25 to-transervica-red/15 rounded-full blur-2xl"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-br from-transervica-red/15 to-transervica-blue-light/20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-r from-transervica-red/5 via-transparent to-transervica-blue-light/5"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-4">
            <span style={{ color: '#DC2626' }}>{t('about.title')}</span>
          </h2>
          <p className="text-2xl lg:text-3xl font-bold mb-6" style={{ color: '#DC2626' }}>
            {t('about.subtitle')}
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20 items-center">
          ...
          <div className="relative">
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-transervica-red via-transervica-blue-light to-transervica-red rounded-3xl blur opacity-30 group-hover:opacity-60 transition duration-1000"></div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{ color: '#DC2626' }}>{t('about.benefit1.title')}</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{ color: '#DC2626' }}>{t('about.benefit2.title')}</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{ color: '#DC2626' }}>{t('about.benefit3.title')}</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{ color: '#DC2626' }}>{t('about.benefit4.title')}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          {/* Misión */}
          <div className="rounded-3xl p-8 border border-transervica-red/20 hover:border-transervica-red/40 transition duration-500 shadow-lg" style={{ backgroundColor: '#DC2626' }}>
          ...
          {/* Visión */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-transervica-blue-light/20 hover:border-transervica-blue-light/40 transition duration-500 shadow-lg">
            <div className="flex items-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-transervica-blue-light to-transervica-red rounded-2xl flex items-center justify-center mr-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
              </div>
              <h3 className="text-3xl font-bold text-transervica-red">{t('about.vision.title')}</h3>
            </div>
        ...
        <div className="text-center">
          <div className="rounded-3xl p-12 border border-transervica-red/30 shadow-xl" style={{ backgroundColor: '#DC2626' }}>
