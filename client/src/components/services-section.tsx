    ...
    <section id="servicios" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="container mx-auto mobile-padding">
        <div className="text-center mb-12 sm:mb-14 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 text-wrap-balance" style={{ color: '#DC2626' }}>
            {t('services.title')}
          </h2>
          ...
          {services.map((service, index) => {
            ...
            return (
              <div
                ...
                style={{ borderLeftColor: '#DC2626', animationDelay: `${index * 100}ms` }}
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center mb-4 sm:mb-6">
                    <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-3" style={{ backgroundColor: 'rgba(21, 93, 41, 0.1)' }}>
                      <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 group-hover:text-white transition-colors duration-500" style={{ color: '#DC2626' }} />
                    </div>
                  </div>
                  
                  <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 transition-colors duration-300 text-wrap-balance" style={{ color: '#DC2626' }}>
                    {service.title}
                  </h3>
                  ...
                  <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    {service.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start text-xs sm:text-sm text-slate-600 group-hover:text-slate-700">
                        <div className="w-2 h-2 rounded-full mr-3 mt-1 flex-shrink-0 transform group-hover:scale-125 transition-transform duration-300" style={{ backgroundColor: '#DC2626' }}></div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-auto pt-3 sm:pt-4">
                    ...
                    <button 
                      ...
                      onMouseEnter={(e) => { (e.target as HTMLElement).style.backgroundColor = '#DC2626'; (e.target as HTMLElement).style.borderColor = '#DC2626'; (e.target as HTMLElement).style.color = 'white'; }}
        ...
        <div className="text-center mt-16">
          <div className="rounded-2xl p-8 md:p-12 shadow-xl border border-gray-100" style={{ backgroundColor: '#DC2626' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                ...
                onMouseEnter={(e) => { (e.target as HTMLElement).style.backgroundColor = '#DBEAFE'; (e.target as HTMLElement).style.color = '#DC2626'; (e.target as HTMLElement).style.borderColor = '#DBEAFE'; }}
